...
class Authorised extends React.Component {
    ...
    loadRecords = async (event) => {
        ...
        const recordsHash = await contract.methods.accessRecords(this.state.Address).call();
    ...
    authorizeNew = async (event) => {
        ...
        try {
            ...
            await contract.methods.authoriseAccount(this.state.Address).send({ from: web3Object.accounts[0] })
            alert("Account Authorised");
        }
        catch (error) {
            alert(error.message);
            console.log(error);
            ...
            <Container>
                <Row>
                    ...
                    <Col md={5}>
                        <Container>
                            <Card>
                                <Card.Header><b>Authorise New Account</b></Card.Header>
                                <Card.Body>
                                    <Form>
                                        <Form.Row className="justify-content-md-center">
                                            <Form.Group as={Col} md={8}>
                                                <Form.Label>Enter Address</Form.Label>
                                                <Form.Control type="text" placeholder="Address" name="Address" onChange={this.handleChange} value={this.state.Address}></Form.Control>
                                            </Form.Group>
                                        </Form.Row>
                                        <Form.Row className="justify-content-md-center">
                                            <Button varient="primary" type="submit" size="lg" onClick={this.authorizeNew}>Authorize Account</Button>
                                        </Form.Row>
                                    </Form>
                                </Card.Body>
                            </Card>
                            <Card>
                                <Card.Header className="justify-content-md-center"><b>User's Medical History</b></Card.Header>
                                <Form>
                                        <Form.Row className="justify-content-md-center">
                                            <Form.Group as={Col} md={8}>
                                                <Form.Label>Enter Address</Form.Label>
                                        ...
                                        <Form.Row className="justify-content-md-center">
                                            <Button varient="primary" type="submit" size="lg" onClick={this.loadRecords}>Get Records</Button>
                                        </Form.Row>
                                </Form>
                                <ol>
                                    {sv}
...
Authorised.contextType = web3Context;
