...
class User extends React.Component {
    ...
    loadRecords = async (event) => {
        ...
        const records = await contract.methods.accessRecords(web3Object.accounts[0]).call();
        ...
        for (let i in records){
            ...
            attribute.value = `https://ipfs.infura.io/ipfs/${records[i]}`;
            var record = document.createTextNode(`${records[i]} \n`);
